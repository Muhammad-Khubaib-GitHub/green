...
@section('pagetitle')
<h2 class="text-white font-weight-bold my-2 mr-5">Edit Shipment</h2>
@endsection
                            ...
                            <div class="card-body p-0">
                                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                        ...
                                        <form class="form" id="kt_form" action="{{ route('shipment.update', $shipment->id) }}" method="POST" onsubmit="return validateForm()">
                                            @csrf
                                            @method('PUT')
                                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="investor_id" class="form-control" id="investorSelect">
                                                            ...
                                                            @foreach ($investors as $investor)
                                                                <option value="{{ $investor->id }}" {{ ($investor->id ==  $shipment->user->id) ? 'selected' : ''}} >
                                                                    {{ $investor->first_name . " " . $investor->last_name }} </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="container_id" class="form-control" id="containerSelect">
                                                            ...
                                                            @foreach ($containers as $container)
                                                                <option value="{{ $container->id }}" {{ ($container->id ==  $shipment->container->id) ? 'selected' : '' }}>
                                                                     {{ $container->id }} </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="form-group">
                                                                <label>Amount</label>
                                                                <input type="number" min=1 class="form-control" name="amount" placeholder="1000" value="{{ $shipment->amount }}" />
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="form-group">
                                                                <label>Profit</label>
                                                                <input type="number" min=1 class="form-control" name="profit" placeholder="10" value="{{ $shipment->profit }}" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control" name="processing_date" placeholder="dd/mm/yyyy" value="{{$shipment->processing_date->format('Y-m-d')}}" />
                                                        ...
                                                        <div class="col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control" name="return_date" placeholder="dd/mm/yyyy" value="{{$shipment->return_date->format('Y-m-d')}}" />
                                                                <span class="form-text text-danger error-msg" style="display: none;">Please select date.</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="current_date" placeholder="dd/mm/yyyy" value="{{$shipment->current_date->format('Y-m-d')}}" />
                                                        <span class="form-text text-danger error-msg" style="display: none;">Please select date.</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-success font-weight-bold text-uppercase px-9 py-4" data-wizard-type="action-submit">Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
