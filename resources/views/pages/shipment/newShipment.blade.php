...
@section('pagetitle')
<h2 class="text-white font-weight-bold my-2 mr-5">New Shipment</h2>
@endsection
                            ...
                            <div class="card-body p-0">
                                <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first" data-wizard-clickable="true">
                                    <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                        ...
                                        <form class="form" id="kt_form" action="{{ route('shipment.store') }}" method="POST" onsubmit="return validateForm()">
                                            @csrf
